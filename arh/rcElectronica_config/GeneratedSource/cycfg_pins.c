...
const cy_stc_gpio_pin_config_t BTLED_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_STRONG_IN_OFF,
	.hsiom = BTLED_HSIOM,
...
const cy_stc_gpio_pin_config_t WIFILED_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_STRONG_IN_OFF,
	.hsiom = WIFILED_HSIOM,
...
const cy_stc_gpio_pin_config_t SLLED_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_STRONG_IN_OFF,
	.hsiom = SLLED_HSIOM,
...
void init_cycfg_pins(void)
{
	...
	Cy_GPIO_Pin_Init(BTLED_PORT, BTLED_PIN, &BTLED_config);

	Cy_GPIO_Pin_Init(WIFILED_PORT, WIFILED_PIN, &WIFILED_config);

	Cy_GPIO_Pin_Init(SLLED_PORT, SLLED_PIN, &SLLED_config);
}
