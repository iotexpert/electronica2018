...
#if !defined(BTBTN_Sns0_PORT) || !defined(BTBTN_Sns0_PIN)
#error BTBTN_Sns0 Sensor is not assigned: missing #define BTBTN_Sns0_PORT, #define BTBTN_Sns0_PIN
#endif

#if !defined(WIFIBTN_Sns0_PORT) || !defined(WIFIBTN_Sns0_PIN)
#error WIFIBTN_Sns0 Sensor is not assigned: missing #define WIFIBTN_Sns0_PORT, #define WIFIBTN_Sns0_PIN
#endif

#if !defined(Slider_Sns0_PORT) || !defined(Slider_Sns0_PIN)
#error Slider_Sns0 Sensor is not assigned: missing #define Slider_Sns0_PORT, #define Slider_Sns0_PIN
#endif

#if !defined(Slider_Sns1_PORT) || !defined(Slider_Sns1_PIN)
#error Slider_Sns1 Sensor is not assigned: missing #define Slider_Sns1_PORT, #define Slider_Sns1_PIN
#endif

#if !defined(Slider_Sns2_PORT) || !defined(Slider_Sns2_PIN)
#error Slider_Sns2 Sensor is not assigned: missing #define Slider_Sns2_PORT, #define Slider_Sns2_PIN
#endif

#if !defined(Slider_Sns3_PORT) || !defined(Slider_Sns3_PIN)
#error Slider_Sns3 Sensor is not assigned: missing #define Slider_Sns3_PORT, #define Slider_Sns3_PIN
#endif

#if !defined(Slider_Sns4_PORT) || !defined(Slider_Sns4_PIN)
#error Slider_Sns4 Sensor is not assigned: missing #define Slider_Sns4_PORT, #define Slider_Sns4_PIN
#endif
...
/*Widget names */
#define CY_CAPSENSE_BTBTN_WDGT_ID (0u)
#define CY_CAPSENSE_WIFIBTN_WDGT_ID (1u)
#define CY_CAPSENSE_SLIDER_WDGT_ID (2u)

/* BTBTN sensor names */
#define CY_CAPSENSE_BTBTN_SNS0_ID (0u)

/* WIFIBTN sensor names */
#define CY_CAPSENSE_WIFIBTN_SNS0_ID (0u)

/* Slider sensor names */
#define CY_CAPSENSE_SLIDER_SNS0_ID (0u)
#define CY_CAPSENSE_SLIDER_SNS1_ID (1u)
#define CY_CAPSENSE_SLIDER_SNS2_ID (2u)
#define CY_CAPSENSE_SLIDER_SNS3_ID (3u)
#define CY_CAPSENSE_SLIDER_SNS4_ID (4u)
...
<Configuration major="1" minor="0">
    ...
    <Widgets>
        <Widget id="BTBTN" type="CSD_BUTTON">
            <WidgetProperties>
                ...
                <Property id="FINGER_CP" value="0.4"/>
        ...
        <Widget id="WIFIBTN" type="CSD_BUTTON">
            <WidgetProperties>
                <Property id="DIPLEXING" value="false"/>
                <Property id="MAX_POS_X" value="300"/>
                <Property id="MAX_POS_Y" value="300"/>
        ...
        <Widget id="Slider" type="LINEAR_SLIDER">
            <WidgetProperties>
                <Property id="DIPLEXING" value="false"/>
