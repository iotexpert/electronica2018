...
wiced_bt_gatt_status_t hello_client_gatt_connection_up( wiced_bt_gatt_connection_status_t *p_conn_status )
{
    ...
    WPRINT_APP_INFO(( "No of connections in hello_client_gatt_connection_up %d\n", g_hello_client_cnt ));
...
{
    --g_hello_client_cnt;
    WPRINT_APP_INFO(( "No of connections in conn_down %d\n", g_hello_client_cnt ));
...
//            p_scan_result->remote_bd_addr[3], p_scan_result->remote_bd_addr[4], p_scan_result->remote_bd_addr[5] ));
    ...
    if ( p_scan_result )
    {
        ...
        WPRINT_APP_INFO((" Found Device matching UUID: %X:%X:%X:%X:%X:%X \n", p_scan_result->remote_bd_addr[0], p_scan_result->remote_bd_addr[1], p_scan_result->remote_bd_addr[2],
                         p_scan_result->remote_bd_addr[3], p_scan_result->remote_bd_addr[4], p_scan_result->remote_bd_addr[5] ));
        ...
        WPRINT_APP_INFO(( "No of connections %d\n", g_hello_client_cnt ));
        start_scan = 0;
