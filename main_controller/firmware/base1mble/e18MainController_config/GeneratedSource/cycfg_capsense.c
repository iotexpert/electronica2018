...
#define CY_CAPSENSE_WIDGET_COUNT (24u)
#define CY_CAPSENSE_SENSOR_COUNT (24u)
#define CY_CAPSENSE_ELTD_COUNT (48u)
#define CY_CAPSENSE_PIN_COUNT (26u)
#define CY_CAPSENSE_SHIELD_PIN_COUNT (0u)
#define CY_CAPSENSE_POSITION_SIZE (0u)
#define CY_CAPSENSE_DEBOUNCE_SIZE (24u)
...
static const cy_stc_capsense_common_config_t cy_capsense_commonConfig =
{
    ...
    .csdIdacMin = 20u,
    .csdIdacCompEn = CY_CAPSENSE_DISABLE,
    .csdFineInitTime = 10u,
...
static const cy_stc_capsense_pin_config_t cy_capsense_pinConfig[CY_CAPSENSE_PIN_COUNT] =
{
    ...
    { /* leftSense10_Rx0 */
        leftSense10_Rx0_PORT,
        leftSense10_Rx0_PIN,
    },
    { /* leftSense11_Rx0 */
        leftSense11_Rx0_PORT,
        leftSense11_Rx0_PIN,
    },
    { /* rightSense0_Rx0 */
        rightSense0_Rx0_PORT,
        rightSense0_Rx0_PIN,
    },
    { /* rightSense0_Tx */
        rightSense0_Tx_PORT,
    ...
    { /* rightSense1_Rx0 */
        rightSense1_Rx0_PORT,
        rightSense1_Rx0_PIN,
    },
    { /* rightSense2_Rx0 */
        rightSense2_Rx0_PORT,
        rightSense2_Rx0_PIN,
    },
    { /* rightSense3_Rx0 */
        rightSense3_Rx0_PORT,
        rightSense3_Rx0_PIN,
    },
    { /* rightSense4_Rx0 */
        rightSense4_Rx0_PORT,
        rightSense4_Rx0_PIN,
    },
    { /* rightSense5_Rx0 */
        rightSense5_Rx0_PORT,
        rightSense5_Rx0_PIN,
    },
    { /* rightSense6_Rx0 */
        rightSense6_Rx0_PORT,
        rightSense6_Rx0_PIN,
    },
    { /* rightSense7_Rx0 */
        rightSense7_Rx0_PORT,
        rightSense7_Rx0_PIN,
    },
    { /* rightSense8_Rx0 */
        rightSense8_Rx0_PORT,
        rightSense8_Rx0_PIN,
    },
    { /* rightSense9_Rx0 */
        rightSense9_Rx0_PORT,
        rightSense9_Rx0_PIN,
    },
    { /* rightSense10_Rx0 */
        rightSense10_Rx0_PORT,
        rightSense10_Rx0_PIN,
    },
    { /* rightSense11_Rx0 */
        rightSense11_Rx0_PORT,
        rightSense11_Rx0_PIN,
    },
};
...
static const cy_stc_capsense_widget_config_t cy_capsense_widgetConfig[CY_CAPSENSE_WIDGET_COUNT] =
{
    ...
    { /* leftSense4 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[4u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[4u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[8u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[4u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* leftSense5 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[5u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[5u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[10u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[5u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* leftSense6 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[6u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[6u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[12u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[6u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* leftSense7 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[7u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[7u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[14u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[7u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* leftSense8 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[8u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[8u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[16u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[8u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* leftSense9 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[9u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[9u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[18u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[9u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* leftSense10 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[10u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[10u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[20u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[10u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* leftSense11 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[11u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[11u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[22u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[11u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* rightSense0 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[12u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[12u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[24u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[12u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* rightSense1 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[13u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[13u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[26u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[13u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* rightSense2 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[14u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[14u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[28u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[14u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* rightSense3 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[15u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[15u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[30u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[15u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* rightSense4 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[16u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[16u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[32u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[16u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* rightSense5 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[17u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[17u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[34u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[17u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* rightSense6 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[18u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[18u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[36u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[18u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* rightSense7 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[19u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[19u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[38u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[19u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* rightSense8 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[20u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[20u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[40u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[20u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* rightSense9 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[21u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[21u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[42u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[21u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* rightSense10 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[22u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[22u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[44u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[22u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
    ...
    { /* rightSense11 */
        .ptrWdContext = &cy_capsense_tuner.widgetContext[23u],
        .ptrSnsContext = &cy_capsense_tuner.sensorContext[23u],
        .ptrEltdConfig = &cy_capsense_electrodeConfig[46u],
        .ptrNoiseEnvelope = NULL,
        .ptrRawFilterHistory = NULL,
        .ptrRawFilterHistoryLow = NULL,
        .iirCoeff = 128u,
        .ptrDebounceArr = &cy_capsense_debounce[23u],
        .ptrDiplexTable = NULL,
        .centroidConfig = 0u,
        .xResolution = 0u,
        .yResolution = 0u,
