...
#define StripLights_GRIDMODE_WRAP    0
    ...
    #define StripLights_ROWS         ((144 +  (10 - 1 ))/(10 ) )
    #define StripLights_TOTAL_LEDS   144

    #define StripLights_ARRAY_COLS   (int32)(144 + 10)
