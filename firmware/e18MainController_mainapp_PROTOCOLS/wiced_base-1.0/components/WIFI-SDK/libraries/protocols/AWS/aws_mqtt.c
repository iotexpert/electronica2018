...
static wiced_result_t mqtt_connection_event_cb( wiced_mqtt_object_t mqtt_object, wiced_mqtt_event_info_t *event )
{
    ...
    switch ( event->type )
    {
        ...
        {
            g_aws_thing.aws_callback( aws, WICED_AWS_EVENT_PUBLISHED, NULL);
            break;
        }

        case WICED_MQTT_EVENT_TYPE_SUBCRIBED:
        {
            g_aws_thing.aws_callback( aws, WICED_AWS_EVENT_SUBSCRIBED, NULL);
            break;
        }

        case WICED_MQTT_EVENT_TYPE_UNSUBSCRIBED:
        {
            g_aws_thing.aws_callback( aws, WICED_AWS_EVENT_UNSUBSCRIBED, NULL);
            break;
        }
