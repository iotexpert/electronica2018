...
wiced_thread_t pumpThreadHandle;
wiced_thread_t levelThreadHandle;
...
wiced_event_flags_t buttonFlags;
...
#define AWS_STACK_SIZE    7000
#define GAME_STACK_SIZE   5500
#define LEVEL_STACK_SIZE  1200
#define PUMP_STACK_SIZE   1200
...
void application_start(void)
{
	...
	uint32_t tempFlags;
	wiced_rtos_wait_for_event_flags(&startFlags,(uint32_t)(TASK_FLAG_PUMP|TASK_FLAG_LEVEL),&tempFlags,WICED_FALSE,WAIT_FOR_ALL_EVENTS,WICED_WAIT_FOREVER);
